export const devices = [
  ...
  },
  {
    ...
    title: 'Parkinson Pen',
    slug: 'parkinson-pen',
    description: 'Parkinson’s disease is often accompanied by involuntary hand tremors that can significantly hinder the performance of everyday tasks. For patients who are also managing diabetes, these tremors can make the independent use of insulin pens difficult or unsafe. To address this challenge, I designed and modeled an adaptive insulin pen incorporating gyroscopic sensors and stabilizing motors to actively counteract tremor motion—drawing inspiration from existing assistive technologies for Parkinson’s patients. The device was engineered with manufacturability in mind, featuring a housing designed for injection molding, and its structural performance under expected loading conditions was validated through finite element analysis (FEA).',
    time: 'November 2025 - December 2025',
    tasks: [
      'Sketch orthogonal and 3D perspectives of the insulin pen',
      'Create a 3D CAD model of electronic and mechanical components',
      'Design the device for manufacturing via injection molding',
      'Conduct FEA to assess the structural integrity of the device',
